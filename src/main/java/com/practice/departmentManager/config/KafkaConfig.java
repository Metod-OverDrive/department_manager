...
import com.practice.departmentManager.config.properties.KafkaProperties;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic taskRemindTopic() {
        return TopicBuilder.name("task-remind")
                .partitions(5)
                .replicas(1)
                .config(
    ...
    public SenderOptions<String, Object> senderOptions() {
        ...
        props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG,
                kafkaProperties.getKeySerializer()
        );
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG,
                kafkaProperties.getValueSerializer()
        );
