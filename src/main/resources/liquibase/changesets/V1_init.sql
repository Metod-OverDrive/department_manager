...
create table if not exists departments_tasks
(
...
alter table departments_tasks
    add constraint fk_departments_tasks_departments foreign key (department_id) references departments (id) on delete cascade on update no action;
alter table departments_tasks
...
alter table departments_employees
    add constraint fk_departments_employees_departments foreign key (department_id) references departments (id) on delete cascade on update no action;
